...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2017 at 02:59 AM
...
INSERT INTO `inventory` (`sku`, `name`, `description`, `category`, `unit_price`, `unit_cost`, `in_stock`, `unit_sold`, `unit_damaged`, `unit_lost`, `reorder_point`, `removed`) VALUES
(1, 'aaa', 'aaa', 'aaa', '0.00', '0.00', 0, 0, 0, 0, 10, '1'),
(4, 'popoyyyy', 'opop', 'ooioi', '10.00', '5.00', 0, 0, 0, 0, 0, '1'),
(5, 'luyuy', 'uyu', 'yuyu', '0.00', '0.00', 0, 0, 0, 0, 0, '1'),
(6, 'iu', 'uiui', 'uiu', '110.00', '80.00', 10, 0, 0, 0, 10, '1'),
(7, 'kjKJkjkk', 'reek', 'KJ', '16.00', '14.00', 16, 0, 0, 0, 3, '1'),
(8, 'as', 'asa', 'asa', '0.00', '0.00', 0, 0, 0, 0, 2, '1'),
(9, 'lk', 'lk', 'lklk', '12.00', '11.00', 0, 0, 0, 0, 1, '1'),
(10, 'luyuy', 'asasasasa sasa asasasas sasassxaxax  saassas', 'asas', '19.00', '15.00', 10, 0, 0, 0, 20, '1'),
(11, 'Camel Electric Fan', 'Desk Fan', 'Appliances', '1250.00', '1000.00', 6, 0, 0, 0, 3, '0'),
(12, 'Samsung Refrigerator', 'Refrigerator with 10 year warranty', 'Appliances', '15000.00', '12000.00', 2, 0, 0, 0, 5, '0'),
(13, 'Samsung 40\" TV', 'Samsung LED TV ', 'Appliances', '32000.00', '24000.00', 12, 0, 0, 0, 5, '0'),
(14, 'Lenovo Laptop', 'Laptop 15\"', 'Gadgets', '24000.00', '20000.00', 0, 0, 0, 0, 4, '0');
...
INSERT INTO `users` (`user_id`, `username`, `password`, `lastname`, `firstname`, `middlename`, `contact`, `email`, `address`, `date_registered`, `removed`, `administrator`, `cashier`, `inventory`, `supplier`, `customer`, `user`, `report`) VALUES
(6, 'admin', 'admin', 'admin', 'admin', 'admin', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0);
...
--
ALTER TABLE `inventory`
  MODIFY `sku` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
