                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Damaged Items Information Table</h3>
                        </div>
                        <div class="panel-body">
                            <button class="btn btn-default" onclick="reload_table()"><i class="fa fa-refresh"></i> &nbsp;Reload</button>
                            <br><br>
                            <table id="damaged-items-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>DamagedNo.</th>
                                        <th>SKU</th>
                    ...
                    <!--===================================================-->
                    <!-- End Striped Table -->
                    <span>&nbsp; <i style = "color: white;" class="fa fa-square"></i> - Unit Damaged value has been added &nbsp; | &nbsp; <i style = "color: #ff6666;" class="fa fa-square"></i> - Unit Damaged value has been removed (due to corrections / modifications)</span>
                </div>
                <!--===================================================-->
                <!--End page content-->
            </div>
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Unit Sold :</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Unit Lost :</label>
                                        <div class="col-md-9">
