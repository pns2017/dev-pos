...
class Users_model extends CI_Model {
	...
	var $table = 'users';
	var $column_order = array('user_id','user_type','username','lastname','firstname','middlename','contact','email','address','removed'); //set column field database for datatable orderable
